	...
	*/
	public sealed class TestScene_Monobehaviour : UnityEngine.MonoBehaviour
	{
		...
		*/
		...
		{
			//audiomixer
			UnityEngine.Audio.AudioMixer t_audiomixer = UnityEngine.Resources.Load<UnityEngine.GameObject>("AudioMixer").GetComponent<BlueBack.Audio.AudioMixer_MonoBehaviour>().audiomixer;
			...
			t_player.LoadRequest(UnityEngine.Resources.Load<UnityEngine.GameObject>("BgmCommon").GetComponent<BlueBack.Audio.Bank_MonoBehaviour>().bank);
